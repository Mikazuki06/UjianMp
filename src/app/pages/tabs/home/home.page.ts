...
export class HomePage  {
  ...
  async sendToWhatsapp() {
    ...
    window.open(`https://api.whatsapp.com/send?phone=6289503649384&text=${output}`, '_blank');
  ...
  async sendToTelegram() {
    ...
    window.open(`https://t.me/ikbalramdani061?start=${output}`, '_blank');
  }
  ...
  async sendToEmail() {
    ...
    const url = `mailto:ikbalramdani061@gmail.com?subject=Data&20Informasi&body=${output}`;
